...
public class RichWindow {
    ...
    private ArrayList<UIComponent> buildPrerequisiteChildren() {
        UIComponent title =
                UIComponents.label(net.minecraft.network.chat.Component.literal(this.windowName))
                        .tooltip(net.minecraft.network.chat.Component.literal(this.windowTooltip))
                ;

        UIComponent minButton =
                UIComponents.button(net.minecraft.network.chat.Component.literal("-"), button -> {this.collapsibleContainer.toggleExpansion();})
        ...
        UIComponent maxButton =
                UIComponents.button(net.minecraft.network.chat.Component.literal("[]"), this::toggleMaximized)
                        .verticalSizing(Sizing.fixed(10))
                        .horizontalSizing(Sizing.fixed(10))
                ;
    ...
    private void toggleMaximized(ButtonComponent button) {
        ...
        if (this.maximized) {
            ...
            Minecraft.getInstance().setScreen(this.owner);
        } else {
            // Maximize
            ...
            Minecraft.getInstance().setScreen(maxedScreen);
        }
    }
    ...
    public UIComponent build() {
        ...
        if (fullHeight) {
            ...
            this.collapsibleContainer = (CollapsibleContainer) UIContainers
                    .collapsible(Sizing.content(), Sizing.content(), net.minecraft.network.chat.Component.literal(""), true)
                    .children(this.children);
